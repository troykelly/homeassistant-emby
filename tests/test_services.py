...
class TestPlaylistServices:
    ...
    @pytest.mark.asyncio
    async def test_create_playlist_with_item_ids(self, hass: HomeAssistant) -> None:
        """Test create_playlist service with initial item IDs."""
        mock_entry = MockConfigEntry(
            domain=DOMAIN,
            data={
                CONF_HOST: "emby.local",
    ...
    @pytest.mark.asyncio
    async def test_create_playlist_connection_error(self, hass: HomeAssistant) -> None:
        """Test create_playlist service connection error."""
        from custom_components.embymedia.exceptions import EmbyConnectionError
        ...
        with patch("custom_components.embymedia.EmbyClient", autospec=True) as mock_client_class:
            ...
            client.async_create_playlist = AsyncMock(
                side_effect=EmbyConnectionError("Connection failed")
            )
            client.close = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_create_playlist_emby_error(self, hass: HomeAssistant) -> None:
        """Test create_playlist service Emby error."""
        from custom_components.embymedia.exceptions import EmbyError
        ...
        with patch("custom_components.embymedia.EmbyClient", autospec=True) as mock_client_class:
            ...
            with pytest.raises(HomeAssistantError, match="Playlist creation failed"):
                await hass.services.async_call(
                    DOMAIN,
                    "create_playlist",
                    {
    ...
    @pytest.mark.asyncio
    async def test_add_to_playlist_connection_error(self, hass: HomeAssistant) -> None:
        """Test add_to_playlist service connection error."""
        from custom_components.embymedia.exceptions import EmbyConnectionError
    ...
    @pytest.mark.asyncio
    async def test_add_to_playlist_emby_error(self, hass: HomeAssistant) -> None:
        """Test add_to_playlist service Emby error."""
        from custom_components.embymedia.exceptions import EmbyError
        ...
        with patch("custom_components.embymedia.EmbyClient", autospec=True) as mock_client_class:
            ...
            with pytest.raises(HomeAssistantError, match="Add failed"):
                await hass.services.async_call(
                    DOMAIN,
                    "add_to_playlist",
                    {
    ...
    @pytest.mark.asyncio
    async def test_remove_from_playlist_connection_error(self, hass: HomeAssistant) -> None:
        """Test remove_from_playlist service connection error."""
        from custom_components.embymedia.exceptions import EmbyConnectionError
    ...
    @pytest.mark.asyncio
    async def test_remove_from_playlist_emby_error(self, hass: HomeAssistant) -> None:
        """Test remove_from_playlist service Emby error."""
        from custom_components.embymedia.exceptions import EmbyError
        ...
        with patch("custom_components.embymedia.EmbyClient", autospec=True) as mock_client_class:
            ...
            with pytest.raises(HomeAssistantError, match="Remove failed"):
                await hass.services.async_call(
                    DOMAIN,
                    "remove_from_playlist",
                    {
